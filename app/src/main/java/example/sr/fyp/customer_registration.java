            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    ...
                    if (password.length() < 6) {
                        ...
                        Toast.makeText(customer_registration.this, "Please Enter The Same Password", Toast.LENGTH_SHORT).show();
                    }
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(customer_registration.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(customer_registration.this, "Registration successfull" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);

                                if (!task.isSuccessful()) {
                                    Toast.makeText(customer_registration.this, "Registration unsuccessfull" + task.getException(),
